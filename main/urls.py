...
from main.views import Homepage,GetToken,lipanampesa,UpdateBalanceAPIView ,GetBalanceAPIView,MpesaCallback,paybill_transactions,PaybillCallbackView,TillCallbackView,Till_transactions
...
urlpatterns=[
     ...
     path('till_transactions/',Till_transactions.as_view()),
